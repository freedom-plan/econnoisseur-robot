...
public class StockApi {
    ...
    public ResponseDto<TickerDto> ticker(MARKET market) {
        HashMap<String, Object> param = new HashMap<>();
        param.put("market", market.toString());
        String response = doRequest(TICKER_PATH, param);
        return JacksonUtil.toObject(response, new TypeReference<ResponseDto<TickerDto>>(){});
    }
    ...
    public ResponseDto<Map<String, BalanceDto>> account() {
        String response = doRequest(BALANCE_PATH, null);
        return JacksonUtil.toObject(response, new TypeReference<ResponseDto<Map<String, BalanceDto>>>(){});
    }
    ...
    private String doRequest(ApiPath apiPath, Map<String, Object> params) {
        if (params == null) {
            params = new HashMap<>();
        }
        ...
        return HttpRequest.request(urlPrefix, apiPath, params, authorization);
    }
}