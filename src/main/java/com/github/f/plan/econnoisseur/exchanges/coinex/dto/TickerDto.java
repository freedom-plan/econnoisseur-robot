...
public class TickerDto {
    ...
    public static class Ticker {
        ...
        public com.github.f.plan.econnoisseur.exchanges.common.dto.Ticker convert() {
            com.github.f.plan.econnoisseur.exchanges.common.dto.Ticker result = new com.github.f.plan.econnoisseur.exchanges.common.dto.Ticker(Code.OK)
                    .setAsk(this.getSell())
                    .setBid(this.getBuy())
